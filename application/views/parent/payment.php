      ...
      <div class="container-fluid">
        ...
        <div class="card card-danger card-outline rounded-0">
          <div class="card-header">
            <h3 class="card-title">
              <?php
              echo 'Expected Payment for '.$row['NAME'].' is $'.number_format(isset($total_fees) ? $total_fees : 0).'. Paid $'.number_format(isset($amount_paid) ? $amount_paid : 0).'. Balance: $'.number_format(isset($pending_amount) ? $pending_amount : 0);
              ?>
            </h3>
