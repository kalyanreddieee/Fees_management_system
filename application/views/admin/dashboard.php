    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            <!-- small card -->
            <div class="small-box rounded-0 shadow border border-danger">
              <div class="inner">
                <h3>
                  <?php  
          ...
          <div class="col-lg-3 col-6">
            <!-- small card -->
            <div class="small-box rounded-0 shadow border border-secondary">
              <div class="inner">
                <h3>
                  <?php  
          ...
          <div class="col-lg-3 col-6">
            <!-- small card -->
            <div class="small-box rounded-0 shadow border border-success">
              <div class="inner">
                <h3>
                  <?php  
                  ...
                  $r=$q->row();
                  echo '$'.number_format(isset($r->amt) ? $r->amt : 0);
                  ?>
                </h3>
                <p>FEES COLLECTION</p>
              </div>
